...
namespace PriceWebService.Controllers {
    ...
    public class ListiniController: Controller {
        ...
        public IActionResult SaveListino([FromBody]Listini listino) {
            ...
            //Contolliamo se il listino è presente
            var isPresent = this.listiniRepository.CheckListino(listino.Id);
            ...
            if (!this.listiniRepository.InsListini(listino))
            {
